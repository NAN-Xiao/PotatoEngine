...
var PBMesssageHandleMap map[int32]func(interface{}) (interface{}, error)
...
func ExcutePBMessage(msg interface{}) (interface{}, error) {
	id, err := GetServerMsgID(msg)
	if err != nil {
		return nil, err
	}
	fc := GetPBNetMessageHandl(id)
	if fc == nil {
		return nil, fmt.Errorf("not regist msghand,msgid ::%d", id)
	}
	return fc(msg)
}
...
func GetPBNetMessageHandl(id int32) func(interface{}) (interface{}, error) {
